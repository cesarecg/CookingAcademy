...
<body>
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 style="text-align:center">Administración de Alumnos GRUPO SEIS</h2>
    ...
    ?>
        ...
        <a href="../pagos/pagos5.php"><button type="button" class="btn btn-success">Administrar Pagos</button></a></div>
        <hr>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      let tabla1 = $('#tabla1').DataTable({
        ...
        responsive: true,
        "ajax": {
          url: 'datos_alumnospredefinidos5.php?accion=listar',
          dataSrc: ""
        },    
        "columns": [{
          "data": "id"
      ...
      function buscarNotas(registro){
        $.ajax({
          type: 'POST',
          url: '../alumnos/datos_alumnospredefinidos5.php?accion=buscarNotas',
          dataType: "json",
          data: registro,
      ...
      function editarRegistro(registro) {
        ...
        $.ajax({
          type: 'POST',
          url: 'datos_alumnospredefinidos5.php?accion=editar',
          dataType:"json",
          data: registro,
      ...
      function cambiarPassword(registro) {
        ...
        $.ajax({
          type: 'POST',
          url: 'datos_alumnospredefinidos5.php?accion=cambiarPass',
          data: registro,
          success: function (msg) {
            tabla1.ajax.reload();
      ...
      function borrarAlumno(registro) {
        $.ajax({
          type: 'POST',
          url: 'datos_alumnospredefinidos5.php?accion=borrar',
          data: registro,
          success: function (msg) {
            tabla1.ajax.reload();
          },
