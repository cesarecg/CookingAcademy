...
<head>
    ...
    <title>Recetas - Le Concassé</title>
...
<section id="recetas">
            ...
            <div class="row" >
                ...
                <div class="col-md-12">
                <br>
                <h2 class="text-left title"> Recetas Saladas</h2>
                <div class="row">
            <?php foreach ($query_sal_main as $q){ ?>
                <div class="col-4 d-flex justify-content-center">
                <div class="card recetas-div">
                <img src="<?php echo './recipes/' . $q['img_url']?>" class="imagen-recetas" alt="...">
                        <div class="card-body">
                        <a href="./recipes/receta_salada.php?id=<?php echo $q['id']?>"> <h5 class="title text-center"><?php echo $q['recipe_name'];?></h5></a>                   
                        </div>
                    </div>
                </div>
            <?php }?>
            </div>  <a href="./recipes/recetas_saladas.php"><h5 class="text-right">Ver Más</h5></a>
        </div>
            ...
            <div class="row" >
                ...
                <h2 class="text-left title">Recetas de Panadería</h2>
                <div class="row">
            <?php foreach ($query_pan_main as $q){ ?>
                <div class="col-4 d-flex justify-content-center">
                <div class="card recetas-div">
                <img src="<?php echo './recipes/' . $q['img_url']?>" class="imagen-recetas" alt="...">
                        <div class="card-body">
                        <a href="./recipes/receta_panaderia.php?id=<?php echo $q['id']?>"> <h5 class="title text-center"><?php echo $q['recipe_name'];?></h5></a>                   
                        </div>
                    </div>
                </div>
            <?php }?>
            </div>  <a href="./recipes/recetas_panaderia.php"><h5 class="text-right">Ver Más</h5></a>
        </div>
                    <hr class="hard-divisor">
                </div>
            ...
            <div class="row">
                ...
                <h2 class="text-left title"> Recetas de Repostería</h2>
                <div class="row">
            <?php foreach ($query_rep_main as $q){ ?>
                <div class="col-4 d-flex justify-content-center">
                <div class="card recetas-div">
                <img src="<?php echo './recipes/' . $q['img_url']?>" class="imagen-recetas" alt="...">
                        <div class="card-body">
                        <a href="./recipes/receta_reposteria.php?id=<?php echo $q['id']?>"> <h5 class="title text-center"><?php echo $q['recipe_name'];?></h5></a>                   
                        </div>
                    </div>
                </div>
            <?php }?>
            </div>  <a href="./recipes/recetas_reposteria.php"><h5 class="text-right">Ver Más</h5></a>
        </div>
                    <hr class="hard-divisor">
                </div>
