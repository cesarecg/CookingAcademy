...
<head>
    ...
    <title>Recetas Repostería - Le Concassé</title>
...
<section  id="recetas">
            ...
            <div class="row">
                <div class="col-md-12">
                <br>
                <h2 class="text-left title"> Recetas Repostería</h2>
                </div>
            </div>      
            <br>
            </div>
       ...
       <div class="row">
            <?php foreach ($query_rep as $q){ ?>
                ...
                <img src=" <?php echo $q['img_url']?>" class="imagen-recetas" alt="...">
                        <div class="card-body">
                        <a href="receta_reposteria.php?id=<?php echo $q['id']?>"> <h5 class="title text-center"><?php echo $q['recipe_name'];?></h5></a>                   
                        </div>
                    </div>
                </div>
            <?php }?>
