...
<head>
    ...
    <title>Nueva receta repostería - Le Concassé</title>
...
<main>
<h2 class="text-center title" style= "margin-bottom: -10px;"> Añadir receta Repostería nueva</h2>
<div class="container mt-5 text-center">
        ...
        <label for="file">Imagen de la receta</label>
            ...
            <input type="text" placeholder="Nombre de la Receta" class="form-control my-3 bg-dark text-white text-center" name="title_rep">
            <textarea name="content_rep" placeholder="Receta" class="form-control my-3 bg-dark text-white" cols="30" rows="10"></textarea>
            <textarea name="ingredients_rep" placeholder="Ingredientes" class="form-control my-3 bg-dark text-white" cols="30" rows="10"></textarea>
            <button class="btn btn-dark" name="new_post_rep">Añadir receta</button>
        </form>
   </div>
