...
<head>
    ...
    <title>Nueva receta panadería - Le Concassé</title>
...
<main>
<h2 class="text-center title" style= "margin-bottom: -10px;"> Añadir receta Panadería nueva</h2>
<div class="container mt-5 text-center">
        <form enctype="multipart/form-data" method="POST">
            ...
            <input type="text" placeholder="Nombre de la Receta" class="form-control my-3 bg-dark text-white text-center" name="title_pan">
            <textarea name="content_pan" placeholder="Receta" class="form-control my-3 bg-dark text-white" cols="30" rows="10"></textarea>
            <textarea name="ingredients_pan" placeholder="Ingredientes" class="form-control my-3 bg-dark text-white" cols="30" rows="10"></textarea>
            <button class="btn btn-dark" name="new_post_pan">Añadir receta</button>
        </form>
   </div>
