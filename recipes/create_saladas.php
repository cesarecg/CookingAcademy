...
<head>
    ...
    <title>Nueva receta salada - Le Concassé</title>
...
<main>
<h2 class="text-center title" style= "margin-bottom: -10px;"> Añadir receta salada nueva</h2>
<div class="container mt-5 text-center">
        ...
        <label for="file">Imagen de la receta</label>
            ...
            <input type="text" placeholder="Nombre de la Receta" class="form-control my-3 bg-dark text-white text-center" name="title_sal">
            <textarea name="content_sal" placeholder="Receta" class="form-control my-3 bg-dark text-white" cols="30" rows="10"></textarea>
            <textarea name="ingredients_sal" placeholder="Ingredientes" class="form-control my-3 bg-dark text-white" cols="30" rows="10"></textarea>
            <button class="btn btn-dark" name="new_post_sal">Añadir receta</button>
        </form>
   </div>
