...
<title>Recetas Repostería Admin - Le Concassé</title>
...
<br>
  ...
  <?php if(isset($_REQUEST['info'])){ ?>
        ...
        <div class="text-center">
            <a href="create_reposteria.php" class="btn btn-success">+ Crear una receta nueva de repostería</a>
        </div>
                ...
                <div class="col-12 col-lg-4 d-flex justify-content-center">
                    <div class="card text-white bg-dark mt-5" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <a href="edit_reposteria.php?id=<?php echo $q['id']?>" class="btn btn-light btn-sm" name="edit">Editar</a>
                            <form method="POST">
                            <input type="text" hidden value='<?php echo $q['img_url']?>' name="img_url">
                            <input type="text" hidden value='<?php echo $q['id']?>' name="id">
                            <button class="btn btn-danger btn-sm ml-2" onclick="return confirm('Estás seguro de borrar esta receta? No habrá manera de recuperarla');" name="delete_rep">Borrar</button>
                            </form>
                            </div>
                        </div>
                    </div>
