...
<head>
    ...
    <title>Evento - Le Concassé</title>
...
<?php foreach($query_events as $q){?>
        ...
        <div class="row">
            <div class="col" >
                <!-- Arreglar imagen enventos para mobile css-->
            <img class="imagen_eventos" src="<?php echo $q['img_url']?>"alt="Imagen Noticia"></img>
            </div>
            </div>
        </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col">
            <h1 class="title"><?php echo $q['event_name'];?></h1>
            
            <p class="paragraph"><?php echo nl2br($q['event_descrip']);?></p>
            </div>
            <?php } ?>  
