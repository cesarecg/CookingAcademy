...
<head>
    ...
    <title>Nueva Noticia - Le Concassé</title>
...
<main>
<h2 class="text-center title" style= "margin-bottom: -10px;"> Añadir Noticia nuevo</h2>
<div class="container mt-5 text-center">
        <form enctype="multipart/form-data" method="POST">
            ...
            <input type="text" placeholder="Nombre de la noticia" class="form-control my-3 bg-dark text-white text-center" name="title_new">
            <textarea name="content_new" placeholder="Descripcion" class="form-control my-3 bg-dark text-white" cols="30" rows="10"></textarea>
            <button class="btn btn-dark" name="new_post_new">Añadir Noticia</button>
        </form>
   </div>
