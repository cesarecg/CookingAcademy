...
<head>
    ...
    <title>Cursos - Le Concassé</title>
...
<body>
   ...
   <section id="cursosMain">
   <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                <div class="row">
                    <div class="col" style="max-width: 33%; margin-left:1%; padding:0px;">
                    <div class="comercial text-center">
                                <br>
                                <img class= "imagen-cursos" src="assets/images/imgBox2.jpeg" alt="Curso Alta Cocina">
                                </img>                              
                            </div>                                   
                    </div>
                    <div class="col" style="max-width:63%;height:30%; margin-right:1%; display: block;background-color: #f7f6f2; ">
                    <h2 class="text-left text-uppercase title-cursos">Alta Cocina</h2>
                    <p class="text-justify paragraph">Este curso completo de alta cocina se divide en 4 secciones: Cocina básica, gastronomía venezolana, gastronomía internacional, panadería y pastelería.</p>
                            <p class ="text-justify paragraph">Duración: 4 meses</p>
                            <a target="_blank" href="https://api.whatsapp.com/send?phone=584127049340&text=&source=&data="> <p class="text-right link-cursos"> Toca aquí para solicitar presupuesto</p> </a><br>
                    </div>
                    </div>
    ...
    <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                <div class="row">
                <div class="col" style="max-width: 60%; display: block;background-color: #f7f6f2; margin-left: auto; ">
                  <h2 class="text-left text-uppercase title-cursos">Maestro Panadero</h2>
                    <p class="text-justify paragraph">Curso detallado sobre técnicas, procedimientos y elaboración de distintas masas, fermentos, y diversos productos de la panadería avanzada.</p>
                    <p class="text-justify paragraph">Duración: 3 meses </p>
                    <a target="_blank" href="https://api.whatsapp.com/send?phone=584127049340&text=&source=&data="> <p class="link-cursos text-right"> Toca aquí para solicitar presupuesto</p> </a><br>
                </div>
                <div class="col" style="max-width: 33%; margin-left:0%; padding:0px;">
                <div class="comercial text-center">
                                <br>
                                <img class= "imagen-cursos" src="assets/images/maestroPanadero.jpg" alt="Curso Maestro Panadero">
                                </img>                              
                </div>      
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="comercial text-center">
                                <br>
                                <img class="imagen-cursos" src="assets/images/pasteleria.jpg" alt="Curso Pastelería Integral">
                                </img>                              
                            </div>                                   
                    </div>
                    <div class="col" style="max-width:63%;height:30% margin-right:1%; display: block;background-color: #f7f6f2; ">
                    <h2 class="text-left text-uppercase title-cursos">Pastelería Integral</h2>
                    <p class="text-justify paragraph">Curso de pastelería en tres secciones: básica, intermedia y avanzada. Comprende todo tipo de masas, cremas, bizcochos, chocolatería y más</p>
                            <p class ="text-justify paragraph">Duración: 4 meses</p>
                            <a target="_blank" href="https://api.whatsapp.com/send?phone=584127049340&text=&source=&data="> <p class="text-right link-cursos"> Toca aquí para solicitar presupuesto</p> </a><br>
                    </div>
                    </div>
...
<section id="cursosMobile" >

<div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                <div class="row" style="max-height: 175px;">
                    <div class="col">
                    <h2 class="text-left text-uppercase title-box" >Alta Cocina</h2>
                    <p class="text-left paragraph-tarjetas">Curso dividido en 4 secciones: cocina básica, gastronomía venezolana, gastronomía internacional, panadería y pastelería.</p>
                    <p class="text-left paragraph-tarjetas" style="padding:0px; margin-top:-10px;">Duración: 4 meses</p>
                    </div><a target="_blank" class="linkC-alta" href="https://api.whatsapp.com/send?phone=584127049340&text=&source=&data=">Toca aquí para solicitar presupuesto</a>
                    <div class="col" style="max-width: 33%; padding:0px;">
                    <img class="imagen-mobile" src="assets/images/imgBox2.jpeg" alt="Curso alta cocina">
                    </img> 
                    </div>
            </div><hr class="hard-divisor">
            ...
            <div class="row">
                ...
                <div class="row" style="max-height: 175px;">
                    <div class="col" style="max-width: 33%;margin-left:2.5%; padding:0px;">
                        <img class= "imagen-mobile" src="assets/images/maestroPanadero.jpg" alt="Curso maestro panadero">
                        </img>
                    </div>
                    <hr>
                    <div class="col" style="margin-left: -1%;">
                    <h2 class="text-left text-uppercase title-box">Maestro panadero</h2>
                    <p class="text-left paragraph-tarjetas">Curso detallado sobre técnicas, procedimientos y elaboración de distintas masas, fermentos, y diversos productos de la panadería avanzada.</p>
                    <p class="text-left paragraph-tarjetas" style="padding:0px; margin-top:-10px;">Duración: 3 meses</p>
                </div> <a target="_blank" class="linkC-panadero" href="https://api.whatsapp.com/send?phone=584127049340&text=&source=&data=">Toca aquí para solicitar presupuesto</a>
                </div><hr class="hard-divisor">
                </div>
            </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="row" style="max-height: 175px;">
                    <div class="col">
                    <h2 class="text-left text-uppercase title-box" >Pasteleria integral</h2>
                    <p class="text-left paragraph-tarjetas">Curso de pastelería en tres secciones: básica, intermedia y avanzada. Comprende todo tipo de masas, cremas, bizcochos, chocolatería y más.</p>
                    <p class="text-left paragraph-tarjetas" style="padding:0px; margin-top:-10px;">Duración: 4 meses</p>
                </div><a target="_blank" class="linkC-pasteleria" href="https://api.whatsapp.com/send?phone=584127049340&text=&source=&data=">Toca aquí para solicitar presupuesto</a>
                    <div class="col" style="max-width: 33%; padding:0px;">
                    <img class="imagen-mobile" src="assets/images/pasteleria.jpg" alt="Curso pasteleria integral">
                    </img> 
                    </div>
            </div><hr class="hard-divisor">
            </div>
