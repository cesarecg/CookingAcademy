...
<body>
  <div class="container-fluid" style="width:100%">
    <section class="content-header">
      <h1>
        Calendario
        <small>Panel de control GRUPO CINCO</small>
      </h1>
    </section>
      ...
      <div class="col-2">
        <div id='external-events'  style="margin-bottom:1em; height: 290px; border: 1px solid #000; overflow: auto;padding:1em">
          ...
          <div id='listaeventospredefinidos'>
            ...
            $datos = mysqli_query($conexion, "SELECT codigo,titulo,horainicio,horafin,colortexto,colorfondo FROM eventospredefinidos4");
        ...
        <div style="text-align:center"><a href=../alumnos/alumnos_predefinidos4.php><button type="button" class="btn btn-success">Alumnos y Notas</button></a>
        </div> 
        <hr>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      let calendario1 = new FullCalendar.Calendar(document.getElementById('Calendario1'), {
        ...
        editable: true,
        events: '../eventos/datoseventos4.php?accion=listar',
      ...
      $('#BotonEventosPredefinidos').click(function() {
        window.location = "../eventos/eventospredefinidos4.php";
      });
      ...
      function agregarRegistro(registro) {
        $.ajax({
          type: 'POST',
          url: '../eventos/datoseventos4.php?accion=agregar',
          data: registro,
      ...
      function modificarRegistro(registro) {
        $.ajax({
          type: 'POST',
          url: '../eventos/datoseventos4.php?accion=modificar',
          data: registro,
          success: function(msg) {
            calendario1.refetchEvents();
          },
      ...
      function borrarRegistro(registro) {
        $.ajax({
          type: 'POST',
          url: '../eventos/datoseventos4.php?accion=borrar',
          data: registro,
          success: function(msg) {
            calendario1.refetchEvents();
          },
