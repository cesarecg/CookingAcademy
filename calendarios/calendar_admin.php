...
<body>
  <div class="container-fluid" style="width:100%">
    <section class="content-header">
      <h1>
        Calendario
        <small>Panel de control GRUPO UNO</small>
      </h1>
    </section>
    ...
    <div class="row">
      ...
      <div class="col-2">
        ...
        <div style="text-align:center"><a href=../alumnos/alumnos_predefinidos.php><button type="button" class="btn btn-success">Alumnos y Notas</button></a>
        </div>
        <hr>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      let calendario1 = new FullCalendar.Calendar(document.getElementById('Calendario1'), {
        ...
        editable: true,
        events: '../eventos/datoseventos.php?accion=listar',
      ...
      $('#BotonEventosPredefinidos').click(function() {
        window.location = "../eventos/eventospredefinidos.php";
      });
      ...
      function agregarRegistro(registro) {
        $.ajax({
          type: 'POST',
          url: '../eventos/datoseventos.php?accion=agregar',
          data: registro,
      ...
      function modificarRegistro(registro) {
        $.ajax({
          type: 'POST',
          url: '../eventos/datoseventos.php?accion=modificar',
          data: registro,
          success: function(msg) {
            calendario1.refetchEvents();
          },
      ...
      function borrarRegistro(registro) {
        $.ajax({
          type: 'POST',
          url: '../eventos/datoseventos.php?accion=borrar',
          data: registro,
          success: function(msg) {
            calendario1.refetchEvents();
          },
