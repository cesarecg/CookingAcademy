...
<div class="container-fluid" style="width:100%">
    <section class="content-header">
      <h1>
        Calendario
        <small> <?php echo $_SESSION["username"]; ?> GRUPO 1</small>
      </h1>
    </section>
    ...
    <div class="row">
      ...
      <div class="col-2">
        ...
        <hr>
        <div style="text-align:center"><a href="../notas/notas.php"><button type="button" class="btn btn-success">Notas</button></a>
        </div>
        <hr>
        <div style="text-align:center"><a href="../pagos/pagos_estudiante.php"><button type="button" class="btn btn-success">Control de Pagos</button></a>
        </div>
        <hr>
