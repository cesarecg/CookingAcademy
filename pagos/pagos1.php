...
<body>
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 style="text-align:center">Administración de Pagos GRUPO DOS</h2>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      let tabla1 = $('#tabla1').DataTable({
        ...
        responsive: true,
        "ajax": {
          url: '../alumnos/datos_alumnospredefinidos1.php?accion=listarPagos',
          dataSrc: ""
        },    
        "columns": [{
          "data": "id"
      ...
      $('#botonVolver').click(function () {
        window.location = "../alumnos/alumnos_predefinidos1.php";
      });
      ...
      function editarPago(registro) {
        ...
        $.ajax({
          type: 'POST',
          url: '../alumnos/datos_alumnospredefinidos1.php?accion=editarP',
          dataType:"json",
          data: registro,
      ...
      function buscarPago(registro){
        $.ajax({
          type: 'POST',
          url: '../alumnos/datos_alumnospredefinidos1.php?accion=buscarPago',
          dataType: "json",
          data: registro,
   ...
   function borrarAlumno(registro) {
        $.ajax({
          type: 'POST',
          url: '../alumnos/datos_alumnospredefinidos1.php?accion=borrar',
          data: registro,
          success: function (msg) {
            tabla1.ajax.reload();
          },
...
function buscarComentarioIns(registro) {
        ...
        $.ajax({
          type: 'POST',
          url: '../alumnos/datos_alumnospredefinidos1.php?accion=buscarComentario',
          dataType: "json",
          data: registro,
          success: function(response){
...
//Guardar Comentarios
      function guardarComentario(registro) {  
        ...
        $.ajax({
          type: 'POST',
          url: '../alumnos/datos_alumnospredefinidos1.php?accion=guardarComentario',
          dataType:"json",
          data: registro,
          success: function (msg) {
            tabla1.ajax.reload();
      ...
      function guardarComentarioUni(registro) {  
        ...
        $.ajax({
          type: 'POST',
          url: '../alumnos/datos_alumnospredefinidos1.php?accion=guardarComentarioUni',
          dataType:"json",
          data: registro,
          success: function (msg) {
            tabla1.ajax.reload();
      ...
      function guardarComentarioBook(registro) {  
        ...
        $.ajax({
          type: 'POST',
          url: '../alumnos/datos_alumnospredefinidos1.php?accion=guardarComentarioBook',
          dataType:"json",
          data: registro,
          success: function (msg) {
            tabla1.ajax.reload();
      ...
      function guardarComentarioGrad(registro) {  
        ...
        $.ajax({
          type: 'POST',
          url: '../alumnos/datos_alumnospredefinidos1.php?accion=guardarComentarioGrad',
          dataType:"json",
          data: registro,
          success: function (msg) {
            tabla1.ajax.reload();
      ...
      $.ajax({
        type: 'POST',
        url: '../alumnos/datos_alumnospredefinidos1.php?accion=guardarComentario1',
        dataType:"json",
        data: registro,
        success: function (msg) {
          tabla1.ajax.reload();
    ...
    function guardarComentario2(registro) {
      ...
      $.ajax({
        type: 'POST',
        url: '../alumnos/datos_alumnospredefinidos1.php?accion=guardarComentario2',
        dataType:"json",
        data: registro,
        success: function (msg) {
          tabla1.ajax.reload();
    ...
    function guardarComentario3(registro) {
      ...
      $.ajax({
        type: 'POST',
        url: '../alumnos/datos_alumnospredefinidos1.php?accion=guardarComentario3',
        dataType:"json",
        data: registro,
        success: function (msg) {
          tabla1.ajax.reload();
    ...
    function guardarComentario4(registro) {
      ...
      $.ajax({
        type: 'POST',
        url: '../alumnos/datos_alumnospredefinidos1.php?accion=guardarComentario4',
        dataType:"json",
        data: registro,
        success: function (msg) {
          tabla1.ajax.reload();
    ...
    function guardarComentario5(registro) {
      ...
      $.ajax({
        type: 'POST',
        url: '../alumnos/datos_alumnospredefinidos1.php?accion=guardarComentario5',
        dataType:"json",
        data: registro,
        success: function (msg) {
          tabla1.ajax.reload();
    ...
    function guardarComentario6(registro) {
      ...
      $.ajax({
        type: 'POST',
        url: '../alumnos/datos_alumnospredefinidos1.php?accion=guardarComentario6',
        dataType:"json",
        data: registro,
        success: function (msg) {
          tabla1.ajax.reload();
    ...
    function guardarComentario7(registro) {
      ...
      $.ajax({
        type: 'POST',
        url: '../alumnos/datos_alumnospredefinidos1.php?accion=guardarComentario7',
        dataType:"json",
        data: registro,
        success: function (msg) {
          tabla1.ajax.reload();
    ...
    function guardarComentario8(registro) {
      ...
      $.ajax({
        type: 'POST',
        url: '../alumnos/datos_alumnospredefinidos1.php?accion=guardarComentario8',
        dataType:"json",
        data: registro,
        success: function (msg) {
          tabla1.ajax.reload();
