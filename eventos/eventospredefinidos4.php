...
<head>
  ...
  <title>Calendario de Eventos GRUPO CINCO</title>
...
<body>
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 style="text-align:center">Administración de Clases Predefinidas GRUPO CINCO</h2>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      let tabla1 = $('#tabla1').DataTable({
        "ajax": {
          url: 'datoseventospredefinidos4.php?accion=listar',
          dataSrc: ""
        },
        "columns": [{
          "data": "codigo"
      ...
      $('#BotonSalir').click(function () {
        window.location = "../Calendarios/calendar_admin4.php";
      });
      ...
      function agregarRegistro(registro) {
        $.ajax({
          type: 'POST',
          url: 'datoseventospredefinidos4.php?accion=agregar',
          data: registro,
      ...
      function borrarRegistro(registro) {
        $.ajax({
          type: 'POST',
          url: 'datoseventospredefinidos4.php?accion=borrar',
          data: registro,
          success: function (msg) {
            tabla1.ajax.reload();
          },
